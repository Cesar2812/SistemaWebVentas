$(document).ready(function () {
    ...
    fetch("/Dashboard/ObtenerResumen").then(response => {
        ...
        if (responseJson.estado) {
            ...
            let barchart_labels;//textos
            let barchart_data;//informacio
            ...
            if (d.ventasUltimaSemana.length > 0) {
                ...
                barchart_labels = ["sin resultado"]
                barchart_data = [0]
            }



            //garfico pie o pastel
            let piechart_labels;//textos
            let piechart_data;//informacio
